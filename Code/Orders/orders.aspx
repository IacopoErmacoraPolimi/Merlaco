    ...
    <div style="margin: 20px;">
        <asp:ListView ID="ListView1" runat="server" DataKeyNames="order_number" DataSourceID="Orders_datasource" OnSelectedIndexChanged="DeleteOrderButton_Click">
            <AlternatingItemTemplate>
                <tr style="text-align:center;background-color: white; color: black; border-width: 2px; border-color: #e9eef2; border-style: solid;">
                    ...
                    <tr runat="server">
                        <td runat="server">
                            <table id="itemPlaceholderContainer" runat="server" border="1" style="width: 75vw; background-color: #FFFFFF; border-collapse: collapse; border-color: #999999; border-style: none; border-width: 1px; font-family: Verdana, Arial, Helvetica, sans-serif;">
                                <tr runat="server" style="text-align: center; background-color: white; color: black; border-width: 2px; border-color: #e9eef2; border-style: solid;">
                                    <th style="padding: 5px;" runat="server">order_number</th>
                                    <th runat="server">N_items</th>
                                    <th runat="server">date</th>
                                    <th id="Th1" runat="server">See Details</th>
                    ...
                    <asp:RoleGroup Roles="admin">
                        <ContentTemplate>
                            ...
                            <asp:SqlDataSource ID="DataSourceGraph" runat="server"
                                ...
                                SelectCommand="SELECT count([order_number]) as DailyOrders, date as Date FROM [Order] group by order_number, date"></asp:SqlDataSource>
                        </ContentTemplate>
                    </asp:RoleGroup>
